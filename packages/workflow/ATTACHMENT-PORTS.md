...
that port to adjust the features it attached.
...
Attachment ports move that power to the place that owns the grammar:
...
```text
Attachment ports are kit-backed, lifecycle-guarded control surfaces.
...
ignorant of downstream option shapes.
